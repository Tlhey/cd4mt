...
# Import OpenAI UNet from the project
# Use the local UNetModel implementation (with conv2d attention qkv/proj) to
# ensure compatibility with existing 2D 1x1-conv checkpoints
from ldm.modules.modules.diffusionmodules.openaimodel import UNetModel as OpenAIUNetModel
    ...
    def __init__(
        ...
        **kwargs
        ...
        if unet_type=='openAI':
            ...
            # Default to OpenAI UNet if SongUNet is not available
            UNet = OpenAIUNetModel
