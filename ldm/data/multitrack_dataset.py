...
class MultiSource_Slakh_Dataset(DS_10283_2325_Dataset):
    ...
    def get_mel_from_waveform(self, waveform):
        # waveform
        y = torch.tensor(waveform).unsqueeze(0)
        # Ensure mel_spectrogram() invariant: inputs must be within [-1, 1]
        # Mixture of stems may slightly exceed 1.0 (e.g., 1.0088); clamp to avoid assertion.
