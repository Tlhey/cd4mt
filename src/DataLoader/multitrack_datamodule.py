...
from DataLoader.multitrack_dataset import DS_10283_2325_Dataset, Slakh_Dataset, MultiSource_Slakh_Dataset
import torch
...
class DataModuleFromConfig(pl.LightningDataModule):
    ...
    def get_data_handler(self):
        if self.path["dataset_type"] == "DS_10283_2325":
            return DS_10283_2325_Dataset
        elif self.path["dataset_type"] == "Slakh":
            return Slakh_Dataset
        elif self.path["dataset_type"] == "MultiSource_Slakh":
            return MultiSource_Slakh_Dataset
        else:
            raise ValueError(f"Unsupported dataset type: {self.path['dataset_type']}")
