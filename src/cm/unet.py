...
class QKVFlashAttention(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ImportError(
                "flash_attn>=2.0.0 is required when attention_type='flash'"
            ) from err
    ...
    def forward(self, qkv, attn_mask=None, key_padding_mask=None, need_weights=False):
        ...
        target_dtype = self.inner_dtype or th.float16
        qkv = qkv.to(dtype=target_dtype)
        qkv = self.inner_attn(
            qkv,
