...
def get_weightings(weight_schedule, snrs, sigma_data): # SNR: Signal-to-Noise Ratio
    # 根据weight_schedule的值，计算weightings
...
#一种 scheduler, 在去噪过程的后期（接近干净图像时）使用更小的时间步间隔 from EDM paper
    def __init__(
        self,
